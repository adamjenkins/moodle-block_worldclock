...
$string['configshowutcoffset'] = 'Show UTC offset';
$string['configsortorder'] = 'Sort order';
$string['configsortorder_help'] = 'Clocks are sorted chronologically by their current local date and time, as if every clock were read at the same instant. Clocks that currently share the same UTC offset are ordered alphabetically by name.';
$string['configsortorderasc'] = 'Ascending (earliest first)';
$string['configsortorderdesc'] = 'Descending (latest first)';
